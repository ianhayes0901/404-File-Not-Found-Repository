...
class App:
    ...
    def host_mode(self):
        ...
        def query(name, requester):
            message = f"Does anyone have {name}?".encode('utf-8')
            broadcast(message)
        ...
        def handle_client(client):
            while True:
                try:
                    ...
                    elif contents[1] in self.send:
                        #client.send("Initiate file transfer".encode('utf-8'))
            ...
            while True:
                try:
                    ...
                    if message == "alias?":
                        ...
                        sys.exit()
                    #elif message == "Initiate file transfer":
